...
import image from '../static/me2.jpg';
  ...
  return (
    ...
    >
      <div style={{
        ...
        <Card className="text-center" style={{ width: '80%', maxWidth: '500px' }}>
          <Card.Img
          ...
          <Card.Body>
            <Card.Text>
              Hi, my name is Jimmy Wang and I am currently a graduating high school 
              student residing in Surrey, Canada, who wishes to persue computer science. 
              This is also my firstself-hosted website built with <SnowPackLOGO />
              Snowpack, <ReactLOGO /> React, and <NodeJSLOGO />.
            </Card.Text>
          </Card.Body>
          <Card.Footer className="text-muted">Updated March 2021</Card.Footer>
        </Card>
      </div>
    </div>
  );
...
function SnowPackLOGO() {
  return (
    ...
    >
      <g transform="translate(-1.000000, 0.000000)" fill="#2e5e82">
        <path
